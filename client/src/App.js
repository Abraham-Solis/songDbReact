...
const App = () => {
  //setting the states and creating State Variables, props, and empty array
  ...
  //function to handle input changed (title,artist,album)
  ...
  const handleAddSong = event => {
    ...
    SongAPI.createSong({
      ...
      .then(song => {
        console.log(song)
        //need Json.parse the Stringify in order to push in data
